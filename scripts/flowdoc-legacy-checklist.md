# FlowDoc: Adoption & Migration Guide

> Guide for adopting FlowDoc in any project: legacy with SDD, legacy without SDD, or new projects.
> Use after running `scripts/flowdoc-migration.sh`.
