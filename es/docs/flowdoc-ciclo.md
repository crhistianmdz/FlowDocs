...
> Ver [ADR-009: SDD Sub-agent Context Pattern](./deprecated/architecture/009-sdd-subagent-context-pattern.md) para cómo el orchestrator proporciona contexto a los sub-agents. ⚠️ **DEPRECADO** — El patrón SDD fue removido en FlowDocs v2.0.
