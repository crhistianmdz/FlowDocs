...
- [RFC-005 — Specialist Architecture](../../docs/architecture/rfc/005-specialist-architecture.md) — the architecture this skill follows
- [flowdoc-assist](../flowdoc-assist/SKILL.md) — the orchestrator that coordinates this specialist
- [flowdoc-discover](../flowdoc-discover/SKILL.md) — invoked when deeper investigation is needed
- [ADR Template](../../docs/templates/architecture/ADR_template.md) — the canonical template source of truth
- [ADR Index](../../docs/architecture/adr/INDEX.md) — the index this skill maintains